                ...
                <div className="chart-wrapper">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={evolutionData} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
                      ...
                      <Tooltip contentStyle={{ background: '#0A0A0A', border: '1px solid #44D62C', borderRadius: '8px' }} itemStyle={{ color: '#fff' }} />
                ...
                <div className="chart-wrapper">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chartData} layout="vertical" margin={{ left: isMobile ? -20 : 40, right: isMobile ? 10 : 30, top: 20, bottom: 20 }}>
                      ...
                      <Tooltip contentStyle={{ background: '#0A0A0A', border: '1px solid #44D62C', borderRadius: '8px' }} itemStyle={{ color: '#fff' }} cursor={{ fill: 'rgba(68, 214, 44, 0.05)' }} />
